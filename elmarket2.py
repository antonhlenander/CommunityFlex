...
from elmarket_env import ElMarketEnv
...
dm = DataManager(cons_path, prod_path, price_path)
...
# PARAMS
##############################################################
NUM_EPISODE_STEPS = len(dm.cons_df) - 1
CUST_MAX_DEMAND = dm.get_agent_maxdemand('Erhverv')
MAX_BID_PRICE = dm.get_maxbidprice() + 100 # Allow agent to bid higher than all other agents
CENTRALPOWER_CAPACITY = dm.get_agent_maxproduction('CentralPower')
