...
#dm = DataManager(prod_path='data/fullyearPV_singleDemand/pv.csv', demand_path='data/fullyearPV_singleDemand/demandprofiles.csv', cap_path='data/eval/caps.csv')
dm = DataManager(demand_path="data/august/demandprofiles.csv", prod_path="data/august/PV.csv", price_path="data/august/elspotprices.csv", cap_path="data/eval/caps.csv")
        ...
        agent_supertypes.update(
            {
                f"CM": StrategicCommunityMediator.Supertype(
                    ...
                    cap_var=1,
                    dso_penalty=50,
                    lagrange_mult=0.4, # 0 for penalty objective, 1 for budget balance objective
                    lagrange_lr=0,
