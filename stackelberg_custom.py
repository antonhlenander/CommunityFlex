...
from phantom.network import Network
from phantom.supertype import Supertype
from phantom.telemetry import logger
from phantom.types import AgentID


class StackelbergEnvCustom(PhantomEnv):
    """
    An modification to the Stackelberg environment included with Phantom.
    ...
    def step(self, actions: Mapping[AgentID, Any], terminate) -> PhantomEnv.Step:
        """
